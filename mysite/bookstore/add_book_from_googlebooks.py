    ...
    while fetched_books < total_books:
        ...
        if response.status_code == 200:
            ...
            for item in items:
                ...
                title = volume_info.get("title", "null")
                authors = volume_info.get("authors", [])  
                description = volume_info.get("description", "null")
                edition1 =volume_info.get("edition","null")
...
# test command from bookstore add_book_from_googlebooks import add_books
